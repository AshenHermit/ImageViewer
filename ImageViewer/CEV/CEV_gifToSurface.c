...
{/*animation initialization*/
    ...
    strcpy_s(anim->status.signature, sizeof anim->status.signature, gif->header.signature);
    strcpy_s(anim->status.version, sizeof anim->status.version, gif->header.version);
